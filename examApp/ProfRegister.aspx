<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProfRegister.aspx.cs" Inherits="examApp.ProfRegister" %>
...
<body>
	...
	<div class="form-wrapper">
		...
		<div class="field-wrapper">
            ...
            <asp:TextBox ID="PasswordConfirm" CssClass="pass" runat="server" placeholder="Confirm Password" TextMode="Password" required OnTextChanged="PasswordConfirm_TextChanged"></asp:TextBox>
